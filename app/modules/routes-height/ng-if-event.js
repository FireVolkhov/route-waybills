...
angular.module('ng-if-event', ['moment-event-service'])
	.directive('ngIfEvent' ,['$animate', '$rootScope', 'momentEvent', function($animate, $rootScope, momentEvent) {
						...
						if (!childScope) {
							...
							$transclude(childScope, function (clone) {
								...
								$animate.enter(clone, $element.parent(), $element, function(){
									...
									if ($attr.ngIfMomentEvent){
										momentEvent.fire($attr.ngIfMomentEvent);
									}
									if ($attr.ngIfListener){
										$scope.$eval($attr.ngIfListener)();
									}
								});
							});
						}
